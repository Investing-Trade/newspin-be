...
| 13 | StockPrice 반복 조회 배치화 | I-2 | 개선 | ✅ | [S3](improvements/S3-stock-price-batch.md) |
...
| 16 | InvestmentReport 구조화 출력 (JSON 스키마) | I-4 | 개선 | ✅ | [S3](improvements/S3-report-structured-output.md) |
...
**라운드 2** — 스테이지 0~4(위 표, "라운드 1") 완료 후, 우선순위상 뒤로 미뤄뒀던 항목을 정리하는 별도 묶음.
